...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception {
        //given
        Member member = createMember();
        Book item = createBook("시골 영감", 10000, 9);
        ...
        assertEquals("주문 취소된 상품은 그만큼 재고가 증가해야 한다.", 9, item.getStockQuantity());
